...
class TestMETJSONForecast(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> METJSONForecast:
        """Test METJSONForecast
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `METJSONForecast`
        """
        model = METJSONForecast()
        if include_optional:
            return METJSONForecast(
                geometry = openapi_client.models.geo_json_point_type.GeoJSON point type(
                    coordinates = [60.5, 11.59, 1001], 
                    type = 'Point', ),
                properties = openapi_client.models.forecast_timeseries.Forecast timeseries(
                    ...
                    timeseries = [
                        openapi_client.models.forecast_for_a_specific_time_step.Forecast for a specific time step(
