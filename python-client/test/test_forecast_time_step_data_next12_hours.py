...
class TestForecastTimeStepDataNext12Hours(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ForecastTimeStepDataNext12Hours:
        """Test ForecastTimeStepDataNext12Hours
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForecastTimeStepDataNext12Hours`
        """
        model = ForecastTimeStepDataNext12Hours()
        if include_optional:
            return ForecastTimeStepDataNext12Hours(
