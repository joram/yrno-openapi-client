...
class ForecastTimeStepDataNext12Hours(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "details": ForecastTimePeriod.from_dict(obj.get("details")) if obj.get("details") is not None else None,
            "summary": ForecastSummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None
        })
        return _obj
