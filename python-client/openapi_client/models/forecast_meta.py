...
class ForecastMeta(BaseModel):
    ...
    """ # noqa: E501
    units: ForecastUnits
    updated_at: StrictStr = Field(description="Update time for this forecast")
    __properties: ClassVar[List[str]] = ["units", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "units": ForecastUnits.from_dict(obj.get("units")) if obj.get("units") is not None else None,
